...
- Use the primary agent for understanding Al's visual intent, resolving ambiguity, integration, and final judgment.
- Automatically delegate bounded implementation and inspection work according to `docs/ORCHESTRATION.md`; give subagents minimal, task-specific context rather than the full conversation.
...
- Cross-provider dispatch and Cursor handoff remain explicit-only: use those skills only when Al asks for them.
